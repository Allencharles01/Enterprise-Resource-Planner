            ...
            <div className="flex max-h-[75vh] flex-1 flex-col overflow-y-auto bg-white dark:bg-slate-900">
              {sentSuccess ? (
                ...
                <form onSubmit={handleSend} className="flex flex-1 flex-col">
                  {/* To Field */}
                  <div className="flex items-center justify-between border-b border-violet-100 px-4 py-2 text-sm dark:border-slate-800">
                    <div className="relative flex flex-1 items-center gap-2">
                      ...
                      {selectedRecipient ? (
                        <div className="flex flex-1 items-center gap-2 py-0.5">
                          <div className="inline-flex items-center gap-2 rounded-xl border border-violet-200 bg-violet-100/90 px-3 py-1 text-xs font-bold text-violet-950 dark:border-slate-700 dark:bg-slate-800 dark:text-violet-200">
                            <span>{selectedRecipient.name}</span>
                            <span className="font-mono text-[11px] font-normal text-violet-700 dark:text-violet-400">
                            ...
                            <button
                              ...
                              className="ml-1 rounded-full p-0.5 text-violet-700 transition-colors hover:bg-violet-200 dark:text-slate-300 dark:hover:bg-slate-700"
                      ...
                      {!selectedRecipient && showSuggestions && filteredEmployees.length > 0 && (
                        <div className="absolute left-14 top-full z-50 mt-1 max-h-60 w-[calc(100%-3.5rem)] overflow-y-auto rounded-xl border border-violet-200 bg-white p-1.5 shadow-2xl dark:border-slate-700 dark:bg-slate-800">
                            ...
                            return (
                              <div
                                ...
                                className={`flex cursor-pointer items-center justify-between rounded-lg px-3 py-2 text-xs transition-colors ${
                                  isHighlighted
                                    ? "bg-violet-100/90 text-violet-950 dark:bg-slate-700 dark:text-white"
                                    : "text-slate-700 hover:bg-violet-50 dark:text-slate-200 dark:hover:bg-slate-700/50"
                                }`}
                              >
                                <div className="flex min-w-0 items-center gap-2">
                                  ...
                                  <span className="shrink-0 rounded-md bg-violet-200/60 px-1.5 py-0.5 font-mono text-[10px] font-extrabold text-violet-800 dark:bg-slate-600 dark:text-violet-300">
                                    {empCode}
                                  </span>
                                </div>
