...
export default function ModuleCard({ module, icon: Icon, onOpen }) {
  ...
  return (
    ...
    >
      <div className="flex h-full items-center justify-center border-r max-lg:border-r-0" style={{ borderColor: "rgba(30, 41, 59, 0.72)" }}>
      ...
      <div className="min-w-0 px-4 max-lg:px-0">
        ...
        <div className="mt-3 flex flex-wrap gap-x-7 gap-y-2">
          {module.labels.map((label) => (
            <span key={label} className="flex items-center gap-2 text-[14px] text-slate-200">
      ...
      <div className="border-l px-7 max-lg:border-l-0 max-lg:px-0" style={{ borderColor: "rgba(30, 41, 59, 0.72)" }}>
